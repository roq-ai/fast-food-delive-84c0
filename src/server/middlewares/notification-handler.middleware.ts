...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.update': {
    roles: ['restaurant-manager', 'delivery-personnel'],
    key: 'order-updated-by-customer',
    tenantPath: ['restaurant', 'order'],
    userPath: [],
  },
  'order.delete': {
    roles: ['restaurant-manager', 'delivery-personnel'],
    key: 'order-cancelled-by-customer',
    tenantPath: ['restaurant', 'order'],
    userPath: [],
  },
  'menu_item.create': {
    roles: ['customer'],
    key: 'menu-item-added-by-restaurant',
    tenantPath: ['restaurant', 'menu_item'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['delivery-personnel'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['restaurant-manager', 'delivery-personnel'];
