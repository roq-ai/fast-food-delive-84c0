...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Fast Food Delivery Services v2`}</title>

        <meta
          name="description"
          content="Experience the Taste of Iconic Cuisine with Fast Food Delivery Services v2 - Your First Intercity Perishable Fast Food Delivery App. Order, Savor, Repeat!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1512152272829-e3139592d56f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmYXN0JTIwZm9vZHxlbnwwfHx8fDE2OTQ1ODUwMTZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@haseebjkhan?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Haseeb Jamil`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Fast Food Delivery Services v2`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the Taste of Iconic Cuisine with Fast Food Delivery Services v2 - Your First Intercity Perishable Fast Food Delivery App. Order, Savor, Repeat!`}
            </Text>
            <Box
