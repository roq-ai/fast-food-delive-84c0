...
import { getDeliveryPersonnelById } from 'apiSdk/delivery-personnels';
import { DeliveryPersonnelInterface } from 'interfaces/delivery-personnel';

function DeliveryPersonnelViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Delivery Personnel Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('delivery_personnel', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/delivery-personnels/edit/${id}`} passHref legacyBehavior>
                    <Button
