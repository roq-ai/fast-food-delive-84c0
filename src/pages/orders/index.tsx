...
export function OrderListPage(props: OrderListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrders({
        ...
        order: params.order,
        searchTermKeys: ['status.contains', 'coupen.contains', 'delivery_charges.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'coupen', header: 'Coupen', accessorKey: 'coupen' },
    { id: 'delivery_charges', header: 'Delivery Charges', accessorKey: 'delivery_charges' },
